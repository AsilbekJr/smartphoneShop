         ...
         (<Grid item xs={12} sm={6} md={3} lg={2.4} sx={{display:"flex", justifyContent:"center"}}>
            ...
            <Link to={`/discount/${product.id}`}>
              ...
              <ProductTitle>
                ...
                <ProductPrice sx={{fontSize:"1rem", textDecoration:"line-through", color:"crimson"}}>{product.price} so'm</ProductPrice>
